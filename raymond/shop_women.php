                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="grid" class="tab-pane fade in active">
                                        ...
                                        <?php 
                                            ...
                                            $id=$_GET['update'];
                                            $sql=mysqli_query($conn,"SELECT * FROM product where p_category in (SELECT category from subcategory where id='$id') and p_subcategory in (SELECT subcategory from subcategory where id='$id')");
                                            ...
                                            <div class="single-product">
                                                <div class="product-image">
                                                    <a href="#">
                                                        <img  alt="Special" src="../theme/kenny/uploads/'.$row['image'].'">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <div class="price-rating">
                                                        ...
                                                        <div class="price">
                                                            <span class="old-price"> <span>&#8377;</span>'.$row['price'].'</span>
                                                            <span class="new-price"><span>&#8377;</span>'.$row['discount'].'</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
