		...
		<div class="wrapper">
			...
			<div class="fixed-sidebar-left">
				<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						<a href="subcategory.php"><i class="icon-basket"></i> Sub-Categories</a>
					</li>
					<li>
						<a href="users.php"><span><i class=" icon-tag"></i></span> Users</a>
					</li>
					<li>
						<a href="add-products.php"><i class=" icon-tag"></i> Add products</a>
					</li>
					...
					<li>
						<a href="product-table.php"><i class="icon-handbag"></i> Product</a>
					</li>
					<li>
						<a href="cart.php"><i class="icon-basket"></i> Orders</a>
					</li>
					<!-- <li>
