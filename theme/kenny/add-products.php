...
if(isset($_POST['submit']))
{
	...
	$image=$_FILES['image']['name'];
  	...
  	$sql=mysqli_query($conn, "insert into product (pname,p_category,p_subcategory,quantity,price,discount,status,description,image)values('$pname','$p_category','$p_subcategory','$quantity','$price','$discount','$status','$description','$image')"); 
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" name="pname" class="form-control" placeholder="Rounded Chair">
														</div>
													</div>
													<!--/span-->
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="input-group">
																...
																<input type="text" class="form-control" name="price" placeholder="153">
															</div>
														</div>
													</div>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="input-group">
																...
																<input type="text" class="form-control" name="discount" placeholder="36%">
															</div>
														</div>
													</div>
													<!--/span-->
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="input-group">
																...
																<input type="text" class="form-control" name="quantity" placeholder="153">
															</div>
														</div>
													</div>
													<div class="col-md-6">
